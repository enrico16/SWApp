...
toDisplay <- c("gene", "snp_ld", "msh", "pvalue", "gene_score", "gene_rank_min", "evidence", "gene_best", "evidence_best", "pubmedlink")
toDownload <- c("gene", "snp_ld", "msh", "pvalue", "gene_score", "gene_rank_min", "evidence", "gene_best", "evidence_best", "pubmedid")
...
shinyServer(function(input, output) {
				...
				sqlOutput1 <- reactive({
					...
					sqlCode <- paste0("select gene, snp_ld, msh, pvalue, gene_score, gene_rank_min, evidence, gene_best, evidence_best, pubmedid from swapp.gene_mesh",
				...
				sqlOutput2 <- reactive({
					...
					sqlCode <- paste0("select gene, snp_ld, msh, pvalue, gene_score, gene_rank_min, evidence, gene_best, evidence_best, pubmedid from swapp.bestld",
									  " where pvalue < ", input$pvalue,
									  " and gene_rank_min >= ", input$gene.rank.min[1], " and gene_rank_min <= ", input$gene.rank.min[2],
									  " and gene_score >= ", input$gene.score[1], " and gene_score <= ", input$gene.score[2],
									  ";")
				...
				sqlOutput3 <- reactive({
					...
					sqlCode <- paste0("select gene, snp_ld, msh, pvalue, gene_score, gene_rank_min, evidence, gene_best, evidence_best, pubmedid from swapp",
									  " where pvalue < ", input$pvalue,
									  " and gene_rank_min >= ", input$gene.rank.min[1], " and gene_rank_min <= ", input$gene.rank.min[2],
									  " and gene_score >= ", input$gene.score[1], " and gene_score <= ", input$gene.score[2],
									  ";")
